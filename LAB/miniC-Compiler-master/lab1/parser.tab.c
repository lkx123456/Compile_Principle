...
static const yytype_uint8 yyprhs[] =
{
      ...
      25,    29,    31,    33,    39,    42,    43,    45,    47,    49,
      54,    59,    63,    65,    69,    72,    77,    78,    81,    84,
      86,    90,    96,   104,   110,   116,   122,   126,   127,   130,
     134,   136,   140,   142,   146,   150,   154,   158,   162,   166,
     170,   175,   179,   183,   188,   192,   197,   201,   206,   210,
     213,   216,   221,   225,   230,   234,   236,   238,   240,   242,
     244,   248
};
...
{
      42,     0,    -1,    43,    -1,    -1,    44,    43,    -1,    46,
      45,    17,    -1,    46,    17,    -1,    46,    51,    54,    -1,
       1,    17,    -1,    50,    -1,    50,    18,    45,    -1,     6,
      -1,    47,    -1,    10,    48,    15,    58,    16,    -1,    10,
      49,    -1,    -1,     4,    -1,     4,    -1,     4,    -1,    50,
      13,     3,    14,    -1,     4,    11,    52,    12,    -1,     4,
      11,    12,    -1,    53,    -1,    53,    18,    52,    -1,    46,
      50,    -1,    15,    58,    55,    16,    -1,    -1,    56,    55,
      -1,    62,    17,    -1,    54,    -1,    38,    62,    17,    -1,
      34,    11,    62,    12,    56,    -1,    34,    11,    62,    12,
      56,    35,    56,    -1,    36,    11,    62,    12,    56,    -1,
      37,    11,    57,    12,    56,    -1,    62,    17,    62,    17,
      62,    -1,    17,    62,    17,    -1,    -1,    59,    58,    -1,
      46,    60,    17,    -1,    61,    -1,    61,    18,    60,    -1,
      50,    -1,    50,    26,    62,    -1,    62,    26,    62,    -1,
      62,    31,    62,    -1,    62,    32,    62,    -1,    62,     5,
      62,    -1,    62,    22,    62,    -1,    62,    22,    22,    -1,
      62,    22,    26,    62,    -1,    62,    23,    62,    -1,    62,
      23,    23,    -1,    62,    23,    26,    62,    -1,    62,    24,
      62,    -1,    62,    24,    26,    62,    -1,    62,    25,    62,
      -1,    62,    25,    26,    62,    -1,    11,    62,    12,    -1,
      23,    62,    -1,    33,    62,    -1,     4,    11,    63,    12,
      -1,     4,    11,    12,    -1,    62,    13,    62,    14,    -1,
      62,    19,     4,    -1,     4,    -1,     3,    -1,     7,    -1,
       8,    -1,     9,    -1,    62,    18,    63,    -1,    62,    -1
};
...
/* Line 1455 of yacc.c  */
#line 67 "parser.y"
    {(yyval.ptr)=mknode(TYPE,NULL,NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[(1) - (1)].type_id));if((yyvsp[(1) - (1)].type_id)=="int")(yyval.ptr)->type=INT;if((yyvsp[(1) - (1)].type_id)=="float")(yyval.ptr)->type=FLOAT;if((yyvsp[(1) - (1)].type_id)=="char")(yyval.ptr)->type=CHAR;if((yyvsp[(1) - (1)].type_id)=="string")(yyval.ptr)->type=STRING;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 71 "parser.y"
    {(yyval.ptr)=mknode(STRUCT_DEC,(yyvsp[(2) - (2)].ptr),NULL,NULL,yylineno);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 75 "parser.y"
    {(yyval.ptr)=mknode(STRUCT_TAG,NULL,NULL,NULL,yylineno);strcpy((yyval.ptr)->struct_name,(yyvsp[(1) - (1)].type_id));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 81 "parser.y"
    {(yyval.ptr)=mknode(ARRAY_DEC,(yyvsp[(1) - (4)].ptr),(yyvsp[(3) - (4)].type_int),NULL,yylineno);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 130 "parser.y"
    {(yyval.ptr)=mknode(PLUS_ONE,(yyvsp[(1) - (3)].ptr),NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,"PLUS_ONE");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 131 "parser.y"
    {(yyval.ptr)=mknode(ASSIGNOP_PLUS,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"ASSIGNOP_PLUS");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 133 "parser.y"
    {(yyval.ptr)=mknode(MINUS_ONE,(yyvsp[(1) - (3)].ptr),NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,"MINUS_ONE");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 134 "parser.y"
    {(yyval.ptr)=mknode(ASSIGNOP_MINUS,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"ASSIGNOP_MINUS");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 136 "parser.y"
    {(yyval.ptr)=mknode(ASSIGNOP_STAR,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"ASSIGNOP_STAR");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 138 "parser.y"
    {(yyval.ptr)=mknode(ASSIGNOP_DIV,(yyvsp[(1) - (4)].ptr),(yyvsp[(4) - (4)].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,"ASSIGNOP_DIV");;}
    break;
...
/* Line 1455 of yacc.c  */
#line 145 "parser.y"
    {(yyval.ptr)=mknode(EXP_ELE,(yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].type_id),NULL,yylineno);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 149 "parser.y"
    {(yyval.ptr)=mknode(CHAR,NULL,NULL,NULL,yylineno);strcpy(yylval.type_char,(yyvsp[(1) - (1)].type_char));(yyval.ptr)->type=CHAR;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 150 "parser.y"
    {(yyval.ptr)=mknode(STRING,NULL,NULL,NULL,yylineno);strcpy(yylval.type_string,(yyvsp[(1) - (1)].type_string));(yyval.ptr)->type=STRING;;}
    break;
